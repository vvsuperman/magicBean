...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Double price1 = BlackScholes_abbreviated.blackScholesCall(price, strike, stDev, timeToExp, interest);
        ...
        Double price3 = BlackScholesFormula.calculate(callOption, price, strike, interest, timeToExp, stDev);
        ...
        price1 = BlackScholes_abbreviated.blackScholesCall(price, strike, stDev, timeToExp, interest);
        System.out.println("  price1 = [" + price1 + "]");

        price2 = bs76.Black76(call, price, strike, timeToExp, interest, stDev);
        System.out.println("  price2 = [" + price2 + "]");

        price3 = BlackScholesFormula.calculate(callOption, price, strike, interest, timeToExp, stDev);
        System.out.println("  price3 = [" + price3 + "]");
    }
