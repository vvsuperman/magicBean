...
public class BeanConfig {
    ...
    public static final String orderExpireTime ="20000";// 订单失效时间: 20s
...
//    public static final String SPOT_SECRET_KEY = "Io5imcwwWzKyW1oWsJ9LjjIY9Dk2fkpqtjuZwrdRYzDON8UEDP5sjPPDMIhKC9KK";
}
