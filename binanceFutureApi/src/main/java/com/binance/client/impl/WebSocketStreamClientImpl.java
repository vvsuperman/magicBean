...
public class WebSocketStreamClientImpl implements SubscriptionClient {
    ...
    @Override
    public void subscribeMarkPricesEvent(
            SubscriptionListener<List<MarkPriceEvent>> subscriptionListener,
            SubscriptionErrorHandler errorHandler) {
        createConnection(
                requestImpl.subscribeMarkPricesEvent(subscriptionListener, errorHandler));
    }

    @Override
    public void subscribepremiumIndexEvent(
                                             SubscriptionListener<AggregateTradeEvent> subscriptionListener,
                                             SubscriptionErrorHandler errorHandler) {
        createConnection(
                requestImpl.subscribepremiumIndexEvent(subscriptionListener, errorHandler));
    }
